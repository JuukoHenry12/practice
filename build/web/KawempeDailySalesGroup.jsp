...
<html>
            ...
            <div class="box">
                ...
                <div class="col-lg-12">
                    ...
                    <h2 class="intro-text text-center">
                        <strong>DAILY SALES AT KAWEMPE BRANCH</strong>
                    </h2>
                    <hr>
                </div>
        
         
    <a href="DailySalesAddKawempe.jsp"  class="btn btn-primary" role="button">Add Sales</a>
    ...
    <sql:query dataSource="${dbsource}" var="result">
       SELECT * , SUM( Commission ) AS 'Total', SUM( Sales ) AS 'Sales_total'
        FROM kawempe_branch GROUP BY Date
    </sql:query>

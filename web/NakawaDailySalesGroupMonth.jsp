...
<html>
            ...
            <div class="box">
                ...
                <div class="col-lg-12">
                    ...
                    <h2 class="intro-text text-center">
                        <strong>MONTHLY SALES AT NAKAWA BRANCH</strong>
                    </h2>
                    <hr>
                </div>
    ...
    <a href="NakawaBranch.jsp"  class="btn btn-success" role="button">Main menu</a>
    <br/><br/>
    ...
    <sql:query dataSource="${dbsource}" var="result">
       SELECT MONTH(Date) AS 'Month',YEAR(Date) AS 'Year',SUM( Commission ) AS 'Total', SUM( Sales ) AS 'Sales_total'
        FROM nakawa_branch GROUP BY month(Date)
    </sql:query>
